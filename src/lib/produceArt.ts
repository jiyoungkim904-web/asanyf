...
const ART: Record<string, string> = {
  ...
  쌀: svg(
    '#eef3ee',
    `<path d="M34 62 h52 a26 26 0 0 1 -52 0 Z" fill="#5aa079" ${S}/>
     <path d="M36 62 a24 12 0 0 1 48 0 Z" fill="#ffffff" ${S}/>
     ${[[48, 56], [60, 53], [72, 56], [54, 60], [66, 60]].map(([x, y]) => `<ellipse cx="${x}" cy="${y}" rx="3" ry="2" fill="#e8ede6"/>`).join('')}
     <path d="M52 44 q4 -12 0 -20 M60 42 q0 -14 0 -22 M68 44 q-4 -12 0 -20" stroke="#c9d9c3" stroke-width="3" fill="none" stroke-linecap="round"/>`,
  ),
