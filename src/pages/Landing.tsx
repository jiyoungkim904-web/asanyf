...
const HOW = [
  ...
  { ico: '📍', title: '산지 방문 콘텐츠', desc: '"산지왔서영" — 농가 방문·인터뷰·수확 체험 콘텐츠로 신뢰를 더합니다.' },
...
const FEATURES = [
  ...
  { fi: '📍', title: '산지왔서영', desc: '배우·아나운서 출신 대표가 직접 찾아가는 산지 방문 콘텐츠.' },
      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <h1>
              아산 농산물을 <span className="accent">AI 콘텐츠로</span>
              <br />
              팔리게 하는 로컬 커머스 플랫폼
            </h1>
            <p className="lead">
              산지 데이터 × AI 숏폼 콘텐츠 × "산지왔서영" 산지 방문 콘텐츠 × 공동구매.
              <br />
              콘텐츠부터 공동구매·온라인 판매까지 한 번에 연결합니다.
            </p>
